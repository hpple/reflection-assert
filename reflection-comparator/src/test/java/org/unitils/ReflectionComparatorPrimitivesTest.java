 ...
 * @author Filip Neven
 */
class ReflectionComparatorPrimitivesTest {
   ...
   */
  @Test
  void testGetDifference_longsNearlyTheSame() {
  ...
  /**
   * Test for two equal autoboxing. An autoboxed primitive should be considered equals to the object
   * version.
   */
  @SuppressWarnings({"UnnecessaryBoxing"})
  @Test
  void testGetDifference_equalsAutoboxing() {
   ...
   */
  @Test
  void testGetDifference_differentTypes() {
   ...
   */
  @Test
  void testGetDifference_notEqualsRight0() {
   ...
   */
  @Test
  void testGetDifference_notEqualsLeft0() {
  ...
  void testGetDifference_notEqualsInnerDifferentValues() {
    Difference result = reflectionComparator
        .getDifference(primitivesInnerA, primitivesInnerDifferentValue);
  ...
  void testInfinity() {
    Difference result = reflectionComparator
        .getDifference(Double.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY);
    assertNull(result);
  }
   ...
   */
  @Test
  void testInfinity_notEqual() {
    Difference result = reflectionComparator
        .getDifference(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
  ...
  private static class Primitives {
     ...
     */
    Primitives(int intValue1, int intValue2, Primitives inner) {

...
public class MapDifference extends Difference {
  ...
  private final Map<Object, Difference> valueDifferences = new IdentityHashMap<>();

  /* The keys of the left map that were missing in the right map */
  private final List<Object> leftMissingKeys = new ArrayList<>();

  /* The keys of the right map that were missing in the left map */
  private final List<Object> rightMissingKeys = new ArrayList<>();

  /* The left object as a map */
  private final Map<?, ?> leftMap;

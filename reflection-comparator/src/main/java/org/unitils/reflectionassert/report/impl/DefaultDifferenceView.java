...
public class DefaultDifferenceView implements DifferenceView {
    ...
    protected String formatDifferrence(ClassDifference classDifference, String fieldName) {
        StringBuilder result = new StringBuilder();
        result.append("Expected: object of type ").append(classDifference.getLeftClass().getSimpleName());
        result.append(", actual: object of type ").append(classDifference.getRightClass().getSimpleName()).append("\n");
        return result.toString();
    }

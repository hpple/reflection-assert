...
/**
 * Creates a report of the given differences. This will first output the differences using the
 * default difference view. If the difference is not a simple difference, this will also output the
 * difference tree using the difference tree view.
 *
 * @author Tim Ducheyne
 * @author Filip Neven
 */
public final class DefaultDifferenceReport implements DifferenceReport {

  static final int MAX_LINE_SIZE = 110;

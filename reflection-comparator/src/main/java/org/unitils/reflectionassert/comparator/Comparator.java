 ...
 * If canCompare returns false, the comparator implementation is not suited to compare the given
 * objects and compare should not be called.
 *
 * @author Tim Ducheyne
 * @author Filip Neven
 */
public interface Comparator {
   ...
   * <p/>
   * This method should always be called before calling the compare method. If false is returned
   * compare should not be invoked.
   *
   ...
   * <p/>
   * The reflection comparator is passed as an argument and can be used to perform inner
   * comparisons. E.g. during the comparison of an object the given comparator can be used to
   * compare the instance fields of the object.
   *
   * @param left The left object
   * @param right The right object

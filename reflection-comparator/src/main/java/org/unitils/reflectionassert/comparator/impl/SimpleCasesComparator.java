 ...
 * Following cases are handled: left and right are the same instance, left or right have a null
 * value,
...
public class SimpleCasesComparator implements Comparator {
  ...
  /**
   * Returns true if both object are the same instance, have a null value, are an
   * Enum/Number/Character or
  ...
  public boolean canCompare(Object left, Object right) {
    ...
    if (left.getClass().getName().startsWith("java.lang")
        || right.getClass().getName().startsWith("java.lang")) {
      return true;
    }

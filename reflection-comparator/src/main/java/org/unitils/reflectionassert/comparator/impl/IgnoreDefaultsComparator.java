...
/**
 * A comparator that filters out java-defaults. If the left object is null, false or 0, both objects
 * are considered equal. This implements the IGNORE_DEFAULTS comparison mode.
 *
 * @author Tim Ducheyne
 * @author Filip Neven
 */

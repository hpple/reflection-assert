...
public final class ReflectionAssert {
  ...
  public static void assertPropertiesNotNull(String message, Object object) {
    ...
    for (Field field : fields) {
      if (!Modifier.isStatic(field.getModifiers())) {
        String formattedMessage = formatMessage(
            message,
            "Property '" + field.getName() + "' in object '" + object + "' is null "
        );
  ...
  private static Object getProperty(Object object, String ognlExpression) {
    try {
      ...
      throw new UnitilsException(
          "Failed to get property value using OGNL expression " + ognlExpression,
          ex
      );
    }
  }
  ...
  /**
   * A function that takes an object and returns the value of the property that is specified by the
   * given ognl expression.
   */
  private static class OgnlTransformer implements Function<Object, Object> {
